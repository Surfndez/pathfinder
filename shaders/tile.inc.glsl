// pathfinder/shaders/tile.inc.glsl
//
...
#define COMBINER_CTRL_MASK_ENABLE               0x1
...
#define COMBINER_CTRL_MASK_SHIFT                0
...
vec4 calculateColorWithMaskAlpha(float maskAlpha,
    ...
    color = composite(color, uDestTexture, uFramebufferSize, fragCoord, compositeOp);
    */
