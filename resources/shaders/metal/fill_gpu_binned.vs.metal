...
vertex main0_out main0(main0_in in [[stage_in]], constant float2& uTileSize [[buffer(1)]], constant float2& uFramebufferSize [[buffer(2)]], device bTiles& _168 [[buffer(0)]])
{
    main0_out out = {};
    uint param = _168.iTiles[(in.aTileIndex * 4) + 1];
    ...
    float2 param_5;
    float2 param_6;
    float4 _200 = computeVertexPosition(param, param_1, param_2, param_3, param_4, param_5, param_6);
    out.vFrom = param_5;
    out.vTo = param_6;
